"""
Read .yaml files and convert to dictionaries.
"""
...
def parse_experiment_config(path: Path, n_fit: int = 4, n_jobs: int = 4) -> Generator[Tuple[int, AgentStats], None, None]:
    """
    Parameters
    ----------
    path : Path
    ...
    with path.open() as file:
        ...
        for agent_path in config["agents"]:
            ...
            output_dir = Path("results") / path.stem / agent_name
